...
\slidetitle[Лекция 1: Об архитектуре]{Архитектура и проектирование информационных систем}{06.09.2022}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \end{itemize}
            \item Коммуникации --- в чате курса в Telegram, \url{https://t.me/+eNuZ2MlQ6mxhNzFi}
            \begin{itemize}
