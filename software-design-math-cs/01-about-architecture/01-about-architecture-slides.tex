...
\slidetitle[Лекция 1: Об архитектуре]{Архитектура и проектирование систем}{01.09.2022}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \image[Ф. Брукс, <<Мифический человеко-месяц>>]{brooksSquare}{0.5}
    ...
    \begin{frame}
        ...
        \image{architectVsDeveloper}{0.35}
        \begin{itemize}
            \item Широта знаний
    ...
    \begin{frame}
        ...
        \image[Garlan D., Shaw M. An introduction to software architecture]{oscilloscopeObjects}{0.5}
    \end{frame}

    \begin{frame}
        \frametitle{Вариант 2: слоистая архитектура}
        \image[Garlan D., Shaw M. An introduction to software architecture]{oscilloscopeLayers}{0.5}
    \end{frame}

    \begin{frame}
        \frametitle{Вариант 3: каналы и фильтры}
        \image[Garlan D., Shaw M. An introduction to software architecture]{oscilloscopeFilters}{0.5}
    \end{frame}

    \begin{frame}
        \frametitle{Вариант 4: модифицированные каналы и фильтры}
        \image[Garlan D., Shaw M. An introduction to software architecture]{oscilloscopeModifiedFilters}{0.5}
    \end{frame}
    ...
    \begin{frame}
        ...
        \image[Z. Quin, ``Software Architecture'']{architectureLifeCycle}{0.5}
    \end{frame}

    \begin{frame}
        \frametitle{Архитектура и требования}
        \image{useCaseDiagram}{0.8}
    \end{frame}
    ...
    \begin{frame}
        ...
        \image{trikRuntimeComponents}{0.8}
    \end{frame}
    ...
    \begin{frame}
        ...
        \framesubtitle{HDFS}
        \image[Nenad Medvidovic]{hadoopDescriptive}{0.9}
    \end{frame}

    \begin{frame}
        \frametitle{Hadoop as-built}
        \framesubtitle{HDFS + MapReduce}
        \image[Nenad Medvidovic]{hdfsMapReduce}{0.7}
    \end{frame}

    \begin{frame}
        \frametitle{Hadoop as-built}
        \framesubtitle{Полная архитектура}
        \image[Nenad Medvidovic]{hadoopFull}{0.9}
    \end{frame}

    \begin{frame}
        \frametitle{Hadoop as-built}
        \framesubtitle{Граф зависимостей}
        \image[Nenad Medvidovic]{hadoopDependencies}{0.5}
    \end{frame}
