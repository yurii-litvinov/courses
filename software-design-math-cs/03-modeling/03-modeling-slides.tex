...
\slidetitle{Лекция 3: Моделирование, UML}{20.09.2022}
...
\begin{document}
    ...
    \section{Фидбэк по домашке}

    \begin{frame}
        \frametitle{Фидбэк по домашке}
        \begin{itemize}
            \item Прикладывайте как решение ссылку сразу на PR
            \item В PR прикрепляйте картинки диаграмм, чтобы не надо было идти по ссылкам на сторонние сервисы или ставить ваш любимый десктопный инструмент
            \item Исходники диаграмм, тем не менее, тоже прикрепляйте
            \item Почти всем --- надо подробнее
        \end{itemize}
    \end{frame}
