...
\slidetitle{Лекция 10: Предметно-ориентированное проектирование}{03.11.2022}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.75\textwidth]{cargoRepositories.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.85\textwidth]{cargoRefactored.png}
        \end{center}
    \end{frame}
