...
\slidetitle[Лекция 1: Об архитектуре]{Проектирование программного обеспечения}{08.02.2024}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item Материалы лекций на \url{https://hwproj.ru/courses/20012}
            \item Балльная система
            \begin{itemize}
                \item 40\% за домашки, 60\% за экзамен
                \item Принцип мажорирующей двойки
            \end{itemize}
            \item Коммуникации --- в чате курса в Telegram, \url{https://t.me/+-KPQ0t4h-HtjMjEy}
            \begin{itemize}
