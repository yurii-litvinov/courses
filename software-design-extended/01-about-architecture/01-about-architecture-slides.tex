...
\slidetitle[Лекция 1: Об архитектуре]{Проектирование программного обеспечения}{13.02.2023}
...
\begin{document}
        ...
        \begin{columns}
            \begin{column}{0.8\textwidth}
                \begin{itemize}
                    ...
                    \item Работа на практиках за небольшие баллы
                    \item Материалы лекций: \url{bit.ly/sd-2023}
                    \item Условия и сдача домашек (для магистров): \url{https://bit.ly/sd-2023-masters-hwproj}
                    \item Балльная система
                    \begin{itemize}
                        \item 40\% за домашки, 60\% за экзамен
                    \end{itemize}
                    \item Коммуникации --- в чате курса в Telegram, \url{https://t.me/+Bo1bNQ1ZTq42ZWIy}
                    \begin{itemize}
            ...
            \begin{column}{0.2\textwidth}
                \begin{center}
                    \includegraphics[width=0.9\textwidth]{courseQrCode.png}
                \end{center}
            \end{column}
        \end{columns}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            \item Сдавать пуллреквестом в свой репозиторий и ссылку на HwProj
