...
\slidetitleext[Часть вторая: архитектурные вопросы]{Лекция 13: Проектирование распределённых приложений}{09.12.2024}{Проектирование распределённых приложений}
