...
\slidetitleext[Часть вторая: архитектурные вопросы]{Лекция 13: Проектирование распределённых приложений}{23.12.2024}{Проектирование распределённых приложений}
