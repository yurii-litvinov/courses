...
\slidetitle{Лекция 9: Архитектурные стили}{11.11.2024}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item \enquote{Многоуровневый клиент-сервер}
    ...
    \begin{frame}
        \frametitle{\enquote{Клиент-сервер}}
        \begin{itemize}
    ...
    \begin{frame}
        ...
        \framesubtitle{\enquote{Порты и адаптеры}}
        \begin{columns}
            \begin{column}{0.6\textwidth}
                \begin{itemize}
                    ...
                    \item Адаптер --- паттерн \enquote{Адаптер} для \enquote{подгонки} интерфейсов
                \end{itemize}
            \end{column}
    ...
    \begin{frame}
        ...
        \end{itemize}
        Типичен для финансовых систем глубокой древности (\enquote{Прадедушка стилей})
        \begin{center}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item Центральная структура данных --- та самая \enquote{Blackboard}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item \enquote{Слушатели} могут подписаться на событие
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item Компоненты: издатели, подписчики, \enquote{маршрутизаторы}
            \item Соединители: как правило, сетевые протоколы, часто механизм наподобие паттерна \enquote{Наблюдатель}
