...
\slidetitle{Практика 6: Архитектурная документация}{20.03.2023}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.7\textwidth]{ieee42010ArchitectureDescription.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.9\textwidth]{ieee42010ArchitectureFramework.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.9\textwidth]{ieee42010Decision.png}
        \end{center}
    \end{frame}
