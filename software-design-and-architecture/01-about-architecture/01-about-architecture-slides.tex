...
\slidetitle[Лекция 1: Об архитектуре]{Проектирование и архитектура ПО}{13.02.2025}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item \url{https://hwproj.ru/courses/40032}
            \end{itemize}
            \item Коммуникация в Teams, в канале команды курса
        \end{itemize}
    \end{frame}
