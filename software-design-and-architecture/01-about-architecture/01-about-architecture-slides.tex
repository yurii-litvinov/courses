...
\slidetitle[Лекция 1: Об архитектуре]{Проектирование и архитектура ПО}{13.02.2024}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item \url{https://hwproj.ru/courses/20014}
            \end{itemize}
            \item Коммуникация в Teams, в команде с кодом \textbf{fjow0mj} или в личке
        \end{itemize}
    \end{frame}
