...
\slidetitle[Требования, рекомендации]{Учебные практики второго курса}{18.09.2023}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \end{itemize}
            \item У преподавателя по практикуму на ЭВМ --- он сможет хотя бы направить
            \item На стажировке
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item Кафедра ожидает, что хотя бы один семестр из двух --- с реализацией
            \end{itemize}
