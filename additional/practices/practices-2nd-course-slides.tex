...
\slidetitle[Требования, рекомендации]{Учебные практики второго курса}{14.09.2023}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item Обратите внимание, там есть фильтры, но пока нет фильтра по кафедрам --- ориентируйтесь на научного руководителя (не консультанта)
            ...
            \item Результат выбора темы \textbf{до конца сентября} записать сюда: \url{https://disk.yandex.ru/i/AmUDvIsAjeE2jw}
            \begin{itemize}
