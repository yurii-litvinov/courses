...
\slidetitleext[Часть вторая: стратегические вопросы]{Лекция 13: Проектирование распределённых приложений}{09.12.2026}{Проектирование распределённых приложений}
