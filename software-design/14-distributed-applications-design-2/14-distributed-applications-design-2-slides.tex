...
\slidetitleext[Часть вторая: стратегические вопросы]{Лекция 13: Проектирование распределённых приложений}{06.12.2023}{Проектирование распределённых приложений}
