...
\slidetitle[Лекция 1: Об архитектуре]{Проектирование программного обеспечения}{02.09.2026}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \end{itemize}
            \item Материалы будут выкладываться на HwProj: \url{https://hwproj.ru/courses/50096}
            \begin{itemize}
