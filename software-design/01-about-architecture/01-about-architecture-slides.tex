...
\slidetitle[Лекция 1: Об архитектуре]{Проектирование программного обеспечения}{06.09.2024}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \end{itemize}
            \item Материалы будут выкладываться на HwProj: \url{https://hwproj.ru/courses/20021}
            \begin{itemize}
