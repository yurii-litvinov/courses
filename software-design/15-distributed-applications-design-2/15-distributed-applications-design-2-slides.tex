...
\slidetitleext[Часть вторая: стратегические вопросы]{Лекция 14: Проектирование распределённых приложений}{13.12.2023}{Проектирование распределённых приложений}
