...
\slidetitleext[Часть вторая: стратегические вопросы]{Лекция 14: Проектирование распределённых приложений}{08.12.2022}{Проектирование распределённых приложений}
