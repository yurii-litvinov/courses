...
\slidetitle{Лекция 3: Моделирование, UML}{21.02.2022}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \end{itemize}
        \begin{center}
            \includegraphics[width=0.4\textwidth]{vendingMachineBlack.png}
    ...
    \begin{frame}
        ...
        \end{itemize}
        \begin{center}
            \includegraphics[width=0.9\textwidth]{sketchesVsFormalNotationsBlack.png}
            \attribution{N. Medvidovic}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \end{itemize}
        \begin{center}
            \includegraphics[width=0.4\textwidth]{concernsBlack.png}
            \attribution{N. Medvidovic}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \end{itemize}
        \begin{center}
            \includegraphics[width=0.4\textwidth]{sequenceDiagramBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=\textwidth]{naturalLanguageBlack.png}
                    \attribution{N. Medvidovic}
                \end{center}
            \end{column}
        \end{columns}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=0.9\textwidth]{informalModelBlack.png}
                    \attribution{N. Medvidovic}
                \end{center}
            \end{column}
        \end{columns}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.6\textwidth}
                \begin{center}
                    \includegraphics[width=\textwidth]{umlBlack.png}
                    \attribution{N. Medvidovic}
                \end{center}
            \end{column}
        \end{columns}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.6\textwidth}
                \begin{center}
                    \includegraphics[width=0.85\textwidth]{aadlBlack.png}
                    \attribution{N. Medvidovic}
                \end{center}
            \end{column}
        \end{columns}
    ...
    \begin{frame}
        ...
        \end{itemize}
        \begin{center}
            \includegraphics[width=0.5\textwidth]{hashTableBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        \frametitle{История}
        \begin{center}
            \includegraphics[width=\textwidth]{umlHistoryBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=\textwidth]{umlDiagramsBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[height=0.8\textheight]{umlClassDiagramBlack.png}
    ...
    \begin{frame}
        ...
        \begin{columns}
            \begin{column}{0.5\textwidth}
                Атрибуты:
                \begin{center}
                    \includegraphics[width=0.5\textwidth]{attributesBlack.png}
                \end{center}
            \end{column}
            \begin{column}{0.5\textwidth}
                Ассоциация-класс:
                \begin{center}
                    \includegraphics[width=0.85\textwidth]{classAssociationBlack.png}
                \end{center}
            \end{column}
        \end{columns}
        \vspace{5mm}
        Ассоциации:
        \begin{center}
            \includegraphics[width=0.5\textwidth]{associationsBlack.png}
        \end{center}
        \attribution{М. Фаулер. ``UML. Основы''}
    \end{frame}
...
public class OrderLine {
    ...
    public Money getPrice() {
        return product.getPrice().multiply(quantity);
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=0.5\textwidth]{orderLineBlack.png}
                \end{center}
            \end{column}
        \end{columns}
    \end{frame}
    ...
    \begin{frame}[fragile]
        ...
        \begin{columns}
            \begin{column}{0.5\textwidth}
                \begin{scriptsize}
                    \begin{center}
                        \includegraphics[width=0.9\textwidth]{twoWayAssociationsBlack.png}
                    \end{center}
...
class Car {
    ...
    private Person _owner;
            ...
            \begin{column}{0.5\textwidth}
                \begin{scriptsize}
                    \begin{center}
                        \includegraphics[width=0.9\textwidth]{personOwnsCarBlack.png}
                    \end{center}
...
class Person {
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.6\textwidth]{interfacesBlack.png}
            \attribution{М. Фаулер. ``UML. Основы''}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \vspace{7mm}
        \begin{center}
            \includegraphics[width=0.5\textwidth]{dependenciesBlack.png}
            \attribution{М. Фаулер. ``UML. Основы''}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        Агрегация:
        \begin{center}
            \includegraphics[height=0.1\textheight]{aggregationBlack.png}
        \end{center}
        \vspace{5mm}
        Композиция:
        \begin{center}
            \includegraphics[height=0.1\textheight]{compositionBlack.png}
        \end{center}
        \attribution{М. Фаулер. ``UML. Основы''}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.7\textwidth]{aggregationAndCompositionExampleBlack.png}
            \attribution{М. Фаулер. ``UML. Основы''}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.95\textwidth]{genericsAndEnumsBlack.png}
            \attribution{М. Фаулер. ``UML. Основы''}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.8\textwidth]{packageDiagramsBlack.png}
            \attribution{М. Фаулер. ``UML. Основы''}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.95\textwidth]{packageDependenciesBlack.png}
            \attribution{М. Фаулер. ``UML. Основы''}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.9\textwidth]{objectDiagramsBlack.png}
            \attribution{М. Фаулер. ``UML. Основы''}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.95\textwidth]{componentDiagramsBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.95\textwidth]{componentDiagramsOverviewBlack.png}
