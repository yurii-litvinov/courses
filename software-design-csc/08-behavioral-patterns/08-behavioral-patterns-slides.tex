...
\slidetitle{Лекция 8: Поведенческие шаблоны}{04.04.2022}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.8\textwidth]{textConverterBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.85\textwidth]{builderBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.7\textwidth]{builderBlack.png}
        \end{center}
        \begin{itemize}
...
MutableNetwork<Webpage, Link> webSnapshot = 
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.9\textwidth]{observerExampleBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.75\textwidth]{observerBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.7\textwidth]{templateMethodMotivationBlack.png}
        \end{center}
        \begin{itemize}
   ...
   if (doc) {
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.4\textwidth}
                \begin{center}
                    \includegraphics[width=\textwidth]{templateMethodBlack.png}
                \end{center}
            \end{column}
        \end{columns}
        \begin{itemize}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.4\textwidth}
                \begin{center}
                    \includegraphics[width=0.7\textwidth]{mediatorMotivationBlack.png}
                \end{center}
            \end{column}
        \end{columns}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.5\textwidth]{mediatorObjectsDiagramBlack.png}
        \end{center}
        \vspace{0.5cm}
        \begin{center}
            \includegraphics[width=0.8\textwidth]{mediatorSequenceBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.7\textwidth]{mediatorStaticStructureBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=\textwidth]{mediatorClassesBlack.png}
                    \vspace{1cm}
                    \includegraphics[width=\textwidth]{mediatorObjectsBlack.png}
                \end{center}
            \end{column}
        \end{columns}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.9\textwidth]{commandExampleBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.75\textwidth]{pasteCommandBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.75\textwidth]{openDocumentCommandBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.75\textwidth]{compositeCommandBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.9\textwidth]{commandBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.9\textwidth]{commandSequenceBlack.png}
        \end{center}
    \end{frame}
...
\end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.7\textwidth]{chainOfResponsibilityExampleBlack.png}
        \end{center}
        \begin{itemize}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.8\textwidth]{chainOfResponsibilityExampleClassesBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=\textwidth]{chainOfResponsibilityBlack.png}
                \end{center}
            \end{column}
        \end{columns}
        \begin{itemize}
...
void MyCheckBox::mousePressEvent(QMouseEvent *event)
{
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.85\textwidth]{stateExampleBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.75\textwidth]{stateBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.4\textwidth]{visitorExampleBlack.png}
        \end{center}
        \begin{itemize}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.7\textwidth]{visitorExampleSolutionBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.75\textwidth]{visitorBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.9\textwidth]{doubleDispatchingBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.9\textwidth]{mementoMotivationBlack.png}
        \end{center}
        \begin{itemize}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.7\textwidth]{mementoBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.6\textwidth]{interpreterBlack.png}
        \end{center}
        \begin{itemize}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.8\textwidth]{regexpBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.6\textwidth]{iteratorBlack.png}
        \end{center}
        \begin{itemize}
