...
\slidetitle{Практика 2: Объектно-ориентированное проектирование}{14.02.2022}
...
class Plus extends Operation {
    ...
    \begin{frame}
        ...
        \begin{itemize}
            \item Паттерн ``Builder'':
                \begin{center}
                    \includegraphics[width=0.4\textwidth]{builderBlack.png}
                \end{center}
            \item Паттерн ``Factory'':
                \begin{center}
                    \includegraphics[width=0.4\textwidth]{factoryBlack.png}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.5\textwidth]{springIoCBlack.png}
        \end{center}
    \end{frame}
...
public class Main {
    ...
    \begin{frame}
        ...
        \begin{columns}
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=0.7\textwidth]{wtfsMinBlack.png}
                \end{center}
                \vspace{-0.8cm}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=0.7\textwidth]{goodCodeXkcdBlack.png}
                \end{center}
                \vspace{-0.8cm}
