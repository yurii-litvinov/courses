...
\end{frame}
    ...
    \begin{frame}[fragile]
        ...
        \begin{center}
            \includegraphics[height=0.3\textheight]{originalPaintBlack.png}
        \end{center}
        \begin{footnotesize}
            \begin{minted}{java}
...
\end{frame}
    ...
    \begin{frame}[fragile]
        ...
        \begin{center}
            \includegraphics[width=0.4\textwidth]{informativeInterfaceForPaintBlack.png}
        \end{center}
        \begin{footnotesize}
            \begin{minted}{java}
...
\end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.9\textwidth]{mixinSideEffectsBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.8\textwidth]{pigmentColorBlack.png}
        \end{center}
    \end{frame}
...
\end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.8\textwidth]{pigmentColorValueObjectBlack.png}
        \end{center}
    \end{frame}
...
\end{frame}
    ...
    \begin{frame}
        ...
        \framesubtitle{Рефакторинг}
        \begin{center}
            \includegraphics[height=0.8\textheight]{stockPaintsBlack.png}
        \end{center}
    \end{frame}
