...
\slidetitle{Практика 6: Архитектурная документация}{14.03.2022}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            \item Проанализировать предметную область, выявить неполные и неоднозначные требования
            \item Сделать первый набросок архитектуры системы
            \item Обсудить возникшие вопросы
        \end{itemize}
    \end{frame}
