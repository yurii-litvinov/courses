...
\slidetitle[Практика 1: задача про CLI]{Проектирование программного обеспечения (практика)}{07.02.2022}
...
\begin{document}
    ...
    \begin{frame}
        ...
        В командах по два человека реализовать простой интерпретатор командной строки, поддерживающий команды:
        \begin{itemize}
...
> $x$y
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item Ссылку на пуллреквест приложить в качестве решения в LMS-системе CSC
            \item Смерджить пуллреквест, когда задача зачтена
            \item \textbf{Дедлайн: 10:00 14.02.2022}
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item Если очень хочется, то три тоже ок
            \end{itemize}
