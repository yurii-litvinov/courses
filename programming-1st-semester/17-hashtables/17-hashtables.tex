...
\slidetitle{Хеш-таблицы}{20.11.2024}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            \item Ещё одна реализация АТД \enquote{множество} или \enquote{ассоциативный массив}
            ...
            \begin{column}{0.75\textwidth}
                \begin{itemize}
                    ...
                    \begin{itemize}
                        \item Не инъективна
                    \end{itemize}
                    \item Чем \enquote{случайнее} она это делает, тем лучше
                    \begin{itemize}
    ...
    \begin{frame}
        \frametitle{Хеш-таблица, \enquote{открытая адресация}}
        \begin{columns}
            \begin{column}{0.55\textwidth}
                \begin{itemize}
                    ...
                    \begin{itemize}
                        ...
                        \item Обычно делают флаг \enquote{ячейка была удалена}
                        \begin{itemize}
...
int h(char *value) {
    ...
    return result;
                ...
                \end{minted}
            \end{footnotesize}
            \item Обычно хеш-функция возвращает просто целое число, а хеш-таблица сама \enquote{загоняет} его в нужный диапазон значений
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item \enquote{Совершенная хеш-функция} --- инъективна
