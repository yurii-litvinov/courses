...
\slidetitleext{Функциональное программирование на языке F\#}{11.02.2026}{Введение}
        ...
        \begin{columns}
            \begin{column}{0.6\textwidth}
                \begin{itemize}
                    ...
                    \begin{itemize}
                        \item \url{https://hwproj.ru/courses/50070}
                    \end{itemize}
                \end{itemize}
            \end{column}
            \begin{column}{0.4\textwidth}
                \begin{center}
                    \includegraphics[width=0.7\textwidth]{courseLink2026.png}
                \end{center}
            \end{column}
        \end{columns}
    \end{frame}
...
let rec sumFirst3 ls acc i =
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item В теории --- ленивость
                \item Ещё более в теории --- распараллеливание
            \end{itemize}
...
let calculate = 
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item Первый раз представлен публике в 2005 г., актуальная версия --- 10.0 (11 ноября 2025 года)
            \item Создавался под влиянием OCaml (практически диалект OCaml под .NET, но со своей важной спецификой)
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item .NET 10 + Visual Studio Code + Ionide
