...
\slidetitleext[Computation Expressions, Workflows]{Вычислительные выражения в F\#}{12.03.2026}{Вычислительные выражения}
...
(f >=> g) >=> h == f >=> (g >=> h)
    ...
    \begin{frame}[fragile]{Пример, DSL для создания презентаций}
        \begin{minted}{fsharp}
// Доменная модель
