...
\slidetitle{Сборка мусора в .NET}{19.05.2023}
...
public static class Program {
    ...
    private static void TimerCallback(Object o) {
        ...
        GC.Collect();
            ...
            % Работает только под .NET Framework и только с C#
        \end{footnotesize}
    \end{frame}
...
public static class Program {
    public static void Main() {
        ...
        \end{scriptsize}
        \begin{itemize}
            \item Или \mintinline{csharp}|using var| в C\# 8 или \mintinline{fsharp}|use| в F\#
        \end{itemize}
    \end{frame}
