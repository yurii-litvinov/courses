...
script: cd $PROJECT_DIR && ./gradlew check
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\end{itemize}
			\item Реализация, в которой надо сделать команды, определяется циклическим сдвигом на \textbf{2} вниз по списку на HwProj, с пропуском несданных решений
			\item Дедлайн: \textbf{10:00 11.03.2019г}.
		\end{itemize}
	\end{frame}
