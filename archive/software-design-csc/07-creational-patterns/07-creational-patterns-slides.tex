...
\slidetitle{Лекция 7: Порождающие шаблоны}{28.03.2022}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.7\textwidth]{noBridgeBlack.png}
            \Huge{$$\downarrow$$}
            \includegraphics[width=0.7\textwidth]{bridgeBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.7\textwidth]{bridgeGeneralBlack.png}
        \end{center}
        \begin{itemize}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.6\textwidth]{pImplBlack.png}
        \end{center}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=0.8\textwidth]{warriorsBlack.png}
                \end{center}
            \end{column}
        \end{columns}
    \end{frame}
...
private:
    Warrior* p;
            ...
            \begin{column}{0.4\textwidth}
                \begin{center}
                    \includegraphics[width=0.95\textwidth]{warriorVirtualCtorBlack.png}
                \end{center}
            \end{column}
        \end{columns}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=0.8\textwidth]{warriorFactoryMethodBlack.png}
                \end{center}
            \end{column}
        \end{columns}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.8\textwidth]{factoryMethodBlack.png}
        \end{center}
        \begin{itemize}
            \item Применимость:
            \begin{itemize}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.9\textwidth]{factoryMethodForTextEditorBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.6\textwidth]{factoryMethodBlack.png}
        \end{center}
        \begin{itemize}
    ...
    \begin{frame}
        ...
        \end{itemize}
        \begin{center}
            \includegraphics[width=0.95\textwidth]{widgetsBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.95\textwidth]{widgetFactoryBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.6\textwidth}
                \begin{center}
                    \includegraphics[width=0.95\textwidth]{abstractFactoryBlack.png}
                \end{center}
            \end{column}
        \end{columns}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=\textwidth]{abstractFactoryBlack.png}
                \end{center}
            \end{column}
        \end{columns}
        \begin{itemize}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.4\textwidth}
                \begin{center}
                    \includegraphics[width=0.6\textwidth]{singletonBlack.png}
                \end{center}
            \end{column}
        \end{columns}
    \end{frame}
...
public class Singleton {
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \end{column}
            \begin{column}{0.4\textwidth}
                \includegraphics[width=\textwidth]{multitonBlack.png}
            \end{column}
        \end{columns}
    \end{frame}
...
ThreadPool.QueueUserWorkItem(
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.9\textwidth]{musicalEditorBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.85\textwidth]{prototypeBlack.png}
        \end{center}
    \end{frame}
