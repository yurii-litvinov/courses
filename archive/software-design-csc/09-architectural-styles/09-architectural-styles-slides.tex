...
\slidetitle{Лекция 9: Архитектурные стили}{11.04.2022}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.5\textwidth]{architecturalStylesHighlightedBlack.png}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=0.7\textwidth]{threeTieredArchitectureBlack.png}
                    \attribution{N. Medvidovic}
                \end{center}
            \end{column}
        \end{columns}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.65\textwidth]{mvcBlack.png}
            \attribution{N. Medvidovic}
        \end{center}
        \begin{itemize}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.65\textwidth]{senseComputeControlBlack.png}
            \attribution{N. Medvidovic}
        \end{center}
        \begin{itemize}
    ...
    \begin{frame}
        ...
        \end{itemize}
        \begin{center}
            \includegraphics[width=0.5\textwidth]{buildingStylesBlack.png}
            \attribution{N. Medvidovic}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=0.7\textwidth]{roofStylesBlack.png}
                    \attribution{N. Medvidovic}
                \end{center}
            \end{column}
        \end{columns}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=0.8\textwidth]{layeredBlack.png}
                    \attribution{N. Medvidovic}
                \end{center}
            \end{column}
        \end{columns}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.35\textwidth]{dddLayersBlack.png}
            \begin{scriptsize}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.4\textwidth}
                \begin{center}
                    \includegraphics[width=0.9\textwidth]{hexagonalArchitectureBlack.png}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.8\textwidth]{hexagonalArchitectureDetailsBlack.png}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=0.8\textwidth]{onionArchitectureBlack.png}
    ...
    \begin{frame}
        \frametitle{Подробности}
        \begin{center}
            \includegraphics[width=0.75\textwidth]{onionArchitectureDetailsBlack.png}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.6\textwidth]{cleanArchitectureBlack.png}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.8\textwidth]{cleanArchitectureControlFlowBlack.png}
            \attribution{https://herbertograca.com/2017/09/28/clean-architecture-standing-on-the-shoulders-of-giants/}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.7\textwidth]{batchBlack.png}
            \attribution{N. Medvidovic}
        \end{center}
    \end{frame}
