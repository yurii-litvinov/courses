...
\slidetitle[Часть вторая: архитектурные вопросы]{Лекция 12: Проектирование распределённых приложений}{02.05.2022}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.8\textwidth]{bigComputeBlack.png}
        \end{center}
        \begin{itemize}
    ...
    \begin{frame}
        \frametitle{Big Data}
        \begin{center}
            \includegraphics[width=0.9\textwidth]{bigDataBlack.png}
        \end{center}
        \begin{itemize}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.9\textwidth]{iotBlack.png}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.7\textwidth]{eventDrivenArchitectureBlack.png}
        \end{center}
        \begin{itemize}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.9\textwidth]{webQueueWorkerBlack.png}
        \end{center}
        \begin{itemize}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.9\textwidth]{nTierArchitectureBlack.png}
        \end{center}
        \begin{itemize}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=\textwidth]{n-tier-physical-bastionBlack.png}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.85\textwidth]{microservicesBlack.png}
        \end{center}
        \begin{itemize}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[height=0.7\textheight]{circuitBreakerSequenceBlack.png}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.5\textwidth]{circuitBreakerStatesBlack.png}
            \attribution{\url{https://martinfowler.com/bliki/CircuitBreaker.html}}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=\textwidth]{rpoRtoExampleBlack.png}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.8\textwidth]{cqrsBlack.png}
