...
\slidetitle{Лекция 5: Моделирование поведения}{14.03.2022}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=0.7\textwidth]{stateTransitionExampleBlack.png}
                \end{center}
            \end{column}
        \end{columns}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=\textwidth]{stateTransitionSyntaxBlack.png}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.7\textwidth]{stateTransitionExample2Black.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{columns}
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=\textwidth]{stateTransitionInternalEventExampleBlack.png}
                \end{center}
            \end{column}
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=0.5\textwidth]{stateTransitionInternalEventsBlack.png}
                \end{center}
            \end{column}
        \end{columns}
        ...
        \begin{columns}
            \begin{column}{0.5\textwidth}
                Вложенные состояния:
                \begin{center}
                    \includegraphics[width=\textwidth]{stateTransitionNestedStatesBlack.png}
                    \attribution{М. Фаулер, UML. Основы}
                \end{center}
            \end{column}
            \begin{column}{0.5\textwidth}
                ...
                \begin{center}
                    \includegraphics[width=0.7\textwidth]{stateTransitionParallelStatesBlack.png}
                \end{center}
            \end{column}
        \end{columns}
    \end{frame}
...
public void handleEvent(PanelEvent anEvent) {
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.4\textwidth]{stateTransitionSyntaxBlack.png}
        \end{center}

        \begin{center}
            \includegraphics[width=0.5\textwidth]{stateTransitionStateTableBlack.png}
            \attribution{М. Фаулер, UML. Основы}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.5\textwidth]{stateTransitionStatePatternBlack.png}
            \attribution{М. Фаулер, UML. Основы}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=0.9\textwidth]{sequenceDiagramSyntaxBlack.png}
                    \attribution{М. Фаулер, UML. Основы}
                \end{center}
            \end{column}
        \end{columns}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.6\textwidth]{sequenceDiagramSyntax2Black.png}
            \attribution{М. Фаулер, UML. Основы}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        \frametitle{Пример}
        \begin{center}
            \includegraphics[width=\textwidth]{sequenceDiagramExampleBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=\textwidth]{sequenceDiagramExample2Black.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.8\textwidth]{sequenceDiagramExample3Black.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.5\textwidth]{sequenceDiagramCreationAndDeletionBlack.png}
            \attribution{М. Фаулер, UML. Основы}
        \end{center}
    \end{frame}
    ...
    if (needsConfirmation) 
        messenger.confirm
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=\textwidth]{sequenceDiagramFramesBlack.png}
                    \attribution{М. Фаулер, UML. Основы}
                \end{center}
            \end{column}
        \end{columns}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=\textwidth]{communicationDiagramBlack.png}
                    \attribution{М. Фаулер, UML. Основы}
                \end{center}
            \end{column}
        \end{columns}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.6\textwidth]{communicationDiagramExampleBlack.png}
    ...
    \begin{frame}
        ...
        \begin{columns}
            \begin{column}{0.5\textwidth}
                ...
                \vspace{3mm}
                \begin{center}
                    \includegraphics[width=0.9\textwidth]{compositeStructureElementBlack.png}
                \end{center}
            \end{column}
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=0.8\textwidth]{compositeStructureDiagramBlack.png}
                    \attribution{М. Фаулер, UML. Основы}
                \end{center}
            \end{column}
        \end{columns}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.45\textwidth]{compositeStructureExampleBlack.png}
            \attribution{http://www.uml-diagrams.org/}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{columns}
            \begin{column}{0.5\textwidth}
                ...
                \vspace{3mm}
                \begin{center}
                    \includegraphics[width=0.9\textwidth]{cooperationAlternateNotationBlack.png}
                \end{center}
            \end{column}
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=0.9\textwidth]{cooperationDiagramBlack.png}
                    \attribution{М. Фаулер, UML. Основы}
                \end{center}
            \end{column}
        \end{columns}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=0.9\textwidth]{cooperationSequenceDiagramBlack.png}
                    \attribution{М. Фаулер, UML. Основы}
                \end{center}
            \end{column}
        \end{columns}
    ...
    \begin{frame}
        ...
        \begin{columns}
            \begin{column}{0.5\textwidth}
                ...
                \vspace{3mm}
                \begin{center}
                    \includegraphics[width=0.9\textwidth]{timingDiagramsBlack.png}
                \end{center}
            \end{column}
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=0.8\textwidth]{timingDiagramsAlternateBlack.png}
                    \attribution{М. Фаулер, UML. Основы}
                \end{center}
            \end{column}
        \end{columns}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.7\textwidth]{timingDiagramExampleBlack.png}
            \attribution{http://www.uml-diagrams.org/}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=0.9\textwidth]{interactionOverviewDiagramsBlack.png}
                    \attribution{М. Фаулер, UML. Основы}
                \end{center}
            \end{column}
        \end{columns}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.7\textwidth]{interactionOverviewExampleBlack.png}
            \attribution{http://www.uml-diagrams.org/}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.6\textwidth}
                \begin{center}
                    \includegraphics[width=0.9\textwidth]{dfdBlack.png}
                \end{center}
            \end{column}
        \end{columns}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.80\textwidth]{idef0Black.png}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.4\textwidth}
                \begin{center}
                    \includegraphics[width=0.9\textwidth]{petriBlack.png}
                \end{center}
            \end{column}
        \end{columns}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.95\textwidth]{petriNetExamplesBlack.png}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \includegraphics[width=0.4\textwidth]{petriAlgebraicAnalysisBlack.png}
            \item Структурный
            \item Редукцией
            \item Пространства состояний
            \begin{textblock}{7}(5.2,-2.75)
                \includegraphics[width=\textwidth]{petriStateSpaceAnalysisBlack.png}
            \end{textblock}
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    \includegraphics[width=0.9\textwidth]{petriUsageExample1Black.png}
    ...
    \begin{frame}
        ...
        \end{itemize}
        \begin{center}
            \includegraphics[width=0.6\textwidth]{petriUsageExample2Black.png}
        \end{center}
    \end{frame}
