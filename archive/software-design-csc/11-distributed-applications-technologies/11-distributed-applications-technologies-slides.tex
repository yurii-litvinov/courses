...
\slidetitle[Часть первая: технические вопросы]{Лекция 11: Проектирование распределённых приложений}{25.04.2022}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.4\textwidth}
                \begin{center}
                    \includegraphics[width=\textwidth]{clientServerBlack.png}
                \end{center}
            \end{column}
        \end{columns}
    \end{frame}
    ...
    \begin{frame}
        \frametitle{RPC}
        \begin{center}
            \includegraphics[width=0.6\textwidth]{rpcBlack.png}
        \end{center}
    \end{frame}
    ...
    \begin{frame}
        ...
        \end{itemize}
        \begin{center}
            \includegraphics[width=0.8\textwidth]{remoteCallsBlack.png}
        \end{center}
    \end{frame}
...
john.writeTo(output);
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.4\textwidth}
                \begin{center}
                    \includegraphics[width=\textwidth]{grpcBlack.png}
                \end{center}
            \end{column}
        \end{columns}
    \end{frame}
...
public void getFeature(int lat, int lon) {
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.4\textwidth}
                \begin{center}
                    \includegraphics[width=\textwidth]{soapBlack.png}
                \end{center}
            \end{column}
        \end{columns}
    \end{frame}
...
<portType name="glossaryTerms">
    ...
    \begin{frame}
        ...
        \end{itemize}
        \begin{center}
            \includegraphics[width=0.6\textwidth]{wcfBlack.png}
...
<configuration>  
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.4\textwidth]{webApiServiceDesignBlack.png}
...
internal record WeatherForecast(DateTime Date, 
    ...
    \begin{frame}
        ...
        \begin{textblock}{3}(8,0)
            \includegraphics[width=\textwidth]{rabbitmqLogoBlack.png}
        \end{textblock}
    \end{frame}
...
channel.BasicConsume(queue: "hello", autoAck: true, consumer: consumer);
    ...
    \begin{frame}
        ...
        \end{itemize}
        \begin{textblock}{3}(8,0)
            \includegraphics[width=\textwidth]{kafkaLogoBlack.png}
        \end{textblock}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=0.6\textwidth]{kafkaArchitectureBlack.png}
