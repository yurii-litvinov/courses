...
\slidetitleext{Объектно-ориентированное программирование на C\#}{17.02.2023}{Введение}
...
\begin{document}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \begin{itemize}
                    ...
                    \item HwProj: \url{https://bit.ly/oop-2023}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \end{itemize}
            \item Три <<бесплатные>> попытки сдачи, дальше минус балл за каждую
    ...
    \begin{frame}
        ...
        \begin{itemize}
            \item Всего около 60 баллов за д/з и по 10 за к/р и зачёт
            \begin{itemize}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item Первая версия --- 2002 год, актуальная --- 08.11.2022, C\# 11
            \item В основном для прикладного ПО
            \item 5-е место в индексе TIOBE на февраль 2023 (после Python, C, C++, Java)
            \begin{itemize}
