...
preonepost pretwopost prethreepost
        ...
        \begin{columns}
            \begin{column}{0.4\textwidth}
                \begin{itemize}
                    ...
                    \item Порядка 350К строк кода на C++
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item Декларативное создание контента
                \item Широко распространённые библиотеки
                \item Простота кода и кроссплатформенность
            \end{itemize}
...
{GOLD 50 100 200}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item 80 тысяч коммитов, более 200 контрибуторов
