...
\slidetitle{О методологиях разработки, Scrum}{10.07.2026}
...
\begin{document}
    ...
    \begin{frame}{Фазы жизненного цикла ПО}
        \begin{itemize}
    ...
    \begin{frame}{Водопадная модель}
        \begin{center}
            \includegraphics[width=0.7\textwidth]{waterfall-model.png}
        \end{center}
    \end{frame}

    \begin{frame}{Спиральная модель}
        \begin{center}
    ...
    \begin{frame}{Команда разработки}
        \begin{itemize}
    ...
    \begin{frame}{Аналоговая канбан-доска}
        \begin{center}
    ...
    \begin{frame}{Большая красивая картинка про спринт}
        \begin{center}
    ...
    \begin{frame}{Когда Scrum может работать плохо}
        \begin{itemize}
